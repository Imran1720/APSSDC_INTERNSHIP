...
public class MainActivity extends AppCompatActivity {
    ...
    public void login(View view) {
        ...
        {
            Toast.makeText(this, "Fill valid username/password", Toast.LENGTH_SHORT).show();
        }
        else{
                ...
                if(e.isEmpty()){
                    ...
                    auth.sendPasswordResetEmail(e).addOnCompleteListener(MainActivity.this, new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful())
                            {
                                Toast.makeText(MainActivity.this, "Resent link sent", Toast.LENGTH_SHORT).show();
                            }
                            else {
    ...
    public boolean isConnected()
    {
        ...
        try {
            ...
            conneted = info != null && (info.isAvailable()) && (info.isConnected());
            return conneted;
        }
        catch (Exception e)
        {
